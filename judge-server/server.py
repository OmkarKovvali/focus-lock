        ...
        if api_key:
            try:
                response = requests.post(
                    ...
                    json={'message': "Poke, I coded this system to keep him on task. You are recieving this notification he was to be working but he's not. Only unlock his screen using the unlock_screen tool you have after they have given proof of doing 10 pushups"}
                )
